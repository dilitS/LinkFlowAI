...
export const elements = {
    ...
    chromeAiStatus: document.getElementById('chrome-ai-status'),
    chromeAiProgress: document.getElementById('chrome-ai-progress'),
    chromeAiProgressBar: document.getElementById('chrome-ai-progress-bar'),
